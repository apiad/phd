...
%%TC:ignore
	...
	\include{./Chapters/Cover-Official/Cover-Official}
	\blankpage
	\include{./Chapters/Cover-Official/Disclaimer}
	\blankpage

	%	<Dedication>	%
	\include{./Chapters/Dedication/Dedication}	%	- Dedication

	%\frontmatter
	\pagestyle{fancyUnnumberedSectionsStyle}	% - Fixing style for the regular chapters
	\include{./Chapters/Acknowledgements/Acknowledgements}	%	- Acknowledgements

	\pagestyle{fancySpecialSectionsStyle}
	\include{./Chapters/Financial-Support/Financial-Support}	%	- Financial support

	%\pagestyle{fancyUnnumberedSectionsStyle}	% - Fixing style for the regular chapters
	%\include{./Chapters/Preface/Preface}	%	- Preface

	\include{./Chapters/Abstract/Resumen}
	\include{./Chapters/Abstract/Abstract}

	%	<Indexes>	%
	\include{./Chapters/TableOfContents/TableOfContents}	%	- Contents
...
%%TC:endignore
    ...
    \include{./Chapters/Future-Work/Future-Work}
