...
minería~\cite{Balahur2011} y en {aprendizaje de ontología de dominio general}~\cite{mitchell2018never}.la cita
...
En contraste, la base de conocimiento de Emotinet~\cite{Balahur2017} está orientada hacia un dominio específico (emociones), y se construye a partir de la anotación manual de entradas de blog, utilizando una estructura semántica general que vincula entidades, acciones y emociones.
