...
que está anotado con sustancias farmacológicas así como las interacciones entre ellas. El corpus DDI es el primer corpus que incluye DDI farmacodinámicos (PD) y farmacocinéticos (PK). Una PD DDI ocurre cuando los efectos farmacológicos de un fármaco se modifican por la presencia de otro fármaco, mientras que una PK DDI es el resultado de la interferencia de la absorción, distribución, metabolismo y / o eliminación de un fármaco por otro fármaco. Si bien hay varios corpus anotados con entidades biológicas y sus relaciones (ver Sección 2), la escasez de corpus anotados para la extracción de DDI es el principal cuello de botella en el desarrollo de sistemas de PNL para esta área de farmacovigilancia.

El corpus DDI ha sido desarrollado para el desafío DDI Extraction 2013 (http://www.cs.york.ac.uk/semeval-2013/task9/), cuyo objetivo principal es proporcionar un marco común para la evaluación de la extracción de información. técnicas aplicadas al reconocimiento de sustancias farmacológicas y la detección de DDI a partir de textos biomédicos. Para ello, se han propuesto dos sub-sub-etapas: el reconocimiento y clasificación de nombres de fármacos y la extracción y clasificación de sus interacciones.

Basado en la división de oraciones durante el preprocesamiento, el corpus DDI-DrugBank contiene 6795 oraciones, y el corpus DDI-MedLine se compone de 2147 oraciones. La Tabla 2 muestra el número de tipos de entidad nombrados anotados en cada corpus. El tipo más común fue fármaco (63 \%) en ambos cuerpos. Sin embargo, los números de otros tipos de entidades difieren entre ambos subcorpora. Por ejemplo, mientras que el segundo tipo más común en el corpus DDI-MedLine fue fármaco-n (23 \%), estas sustancias casi nunca se encuentran en el corpus DDI-DrugBank. En cuanto a las relaciones, la Tabla 3 muestra los números de las relaciones anotadas en cada corpus. El efecto fue la relación dominante encontrada en todo el corpus DDI. Los consejos, que representan el 20,9 \% del total de la relación, mostraron una desproporción aún mayor entre ambos corpora porque la proporción de relaciones entre las interacciones del consejo en el corpus DDI-DrugBank (22 \%) es mucho mayor que en el corpus DDI-Medline ( 5 \%).
