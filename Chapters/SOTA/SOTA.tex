...
El corpus de CLEF presentado en esta sección se construyó para el Laboratorio y Taller de Evaluación de eHealth, CLEF 2019~\cite{}.
En este taller se presentaron a la comunidad científica dos tareas: Extracción de información multilingüe, en concreto, en documentos de clasificación internacional de enfermedades, versión 10 (ICD-10) y codificación de resúmenes no técnicos (NTS) de experimentos con animales en alemán; y revisiones asistidas por tecnología (TAR) en medicina empírica en inglés.

La tarea de extracción de información multilingüe desafió a los participantes a indexar los NTS alemanes de experimentos con animales con la terminología de enfermedades de la CIE-10.
Puede considerarse como una clasificación de texto o como una tarea de normalización y reconocimiento de entidades nombradas en cascada.
